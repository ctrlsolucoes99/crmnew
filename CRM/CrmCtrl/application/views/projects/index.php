<div class="ciuis-body-content" ng-controller="Projects_Controller">
          ...
          <div id="project-card" class="ciuis-project-card">
            <div class="ciuis-project-content">
              <div class="ciuis-content-header">
                <div class="pull-left">
                  <p class="md-m-0" style="font-size: 14px;font-weight: 900"> <a href="<?php echo base_url('/projects/project/') ?>{{project.id}}" ng-bind="project.name"></a> </p>
                  <small ng-bind="project.customer"></small> </div>
                <div class="pull-right md-pr-10"> <i ng-click='CheckPinned($index)' data-toggle="tooltip" data-placement="bottom" data-container="body" title="" data-original-title="Pin Project" class="ciuis-project-badge pull-right ion-pin"></i> <img data-toggle="tooltip" data-placement="left" data-container="body" title="" data-original-title="{{project.status}}" class="pull-right md-mr-5" height="32" ng-src="{{IMAGESURL}}{{project.status_icon}}"> </div>
              </div>
              ...
              <div class="ciuis-project-stat col-md-12">
                <div class="col-md-6 bottom-left">
                  <div class="progress-widget">
                    <div class="progress-data text-left"><span class="progress-value" ng-bind="project.progress+'%'"></span> <span class="name" ng-bind="project.status"></span> </div>
  ...
  <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-3 md-pl-0">
    ...
    <div class="col-md-12 pinnedprojects">
      <div class="panel-default">
        <div class="pinned-projects-header"> <span><i class="ion-pin"></i> <?php echo lang('pinnedprojects'); ?></span> <span class="pull-right hide-pinned-projects"><a data-toggle="collapse" data-parent="#pinned-projects" href="#pinned-projects"><i class="icon mdi ion-minus-circled"></i></a></span> </div>
        <div id="pinned-projects" class="panel-collapse collapse in">
          <div class="pinned-projects">
            <div ng-repeat="project_pinned in pinnedprojects | filter: { pinned: '1' }" class="pinned-project-widget">
              ...
              <a ng-click='UnPinned($index)' class="pinned-project-action pull-right"><i class="ion-close-round"></i></a> <a href="<?php echo base_url('projects/project/')?>{{project_pinned.id}}" class="pinned-project-action pull-right"><i class="ion-android-open"></i></a> </div>
          </div>
        </div>
      </div>
    </div>
