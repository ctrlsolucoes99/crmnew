...
<div class="ciuis-body-content" ng-controller="Leads_Controller">
  <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-12">
    ...
    <div class="main-content container-fluid col-xs-12 col-md-9 col-lg-9 md-p-0 lead-table">
      <md-toolbar class="toolbar-white">
        <div class="md-toolbar-tools">
          ...
          <md-button ng-if="!KanbanBoard" ng-click="ShowKanban()"class="md-icon-button" aria-label="Show Kanban">
            <md-tooltip md-direction="bottom">Show Kanban</md-tooltip>
          ...
          <md-button ng-if="KanbanBoard" ng-click="HideKanban()"class="md-icon-button" aria-label="Show List">
            <md-tooltip md-direction="bottom">Show List</md-tooltip>
      ...
      <md-content ng-if="KanbanBoard" class="ciuis_lead_kanban_board" style="padding: 0px">
    ...
    <md-content>
      <md-content layout-padding>
        ...
        <md-input-container class="md-block">
          ...
          <input mdc-datetime-picker="" date="true" time="true" type="text" id="datetime" placeholder="<?php echo lang('chooseadate') ?>" show-todays-date="" minutes="true" show-icon="true" ng-model="lead.date_contacted" class=" dtp-no-msclear dtp-input md-input">
        </md-input-container>
