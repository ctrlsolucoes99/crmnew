	...
	<div class="container">
		<div class="row">
			<div class="page-header">
				...
				<small class="pull-right" style="position:relative;top:20px;right:20px;"><strong><span class="text-uppercase"><?php echo lang('proposal') ?></span> <br># <?php echo '' . lang( 'proposalprefix' ) . '-' . str_pad( $proposals['id'], 6, '0', STR_PAD_LEFT ) . '' ?>
